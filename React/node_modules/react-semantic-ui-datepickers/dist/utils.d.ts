...
export declare const formatDate: (date: Date | null, dateFormat: string) => string | undefined;
...
export declare const formatSelectedDate: (selectedDate: Date | Date[] | null | undefined, dateFormat: string) => string | undefined;
