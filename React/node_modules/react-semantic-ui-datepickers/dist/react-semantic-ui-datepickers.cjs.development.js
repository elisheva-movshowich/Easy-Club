...
var v2 = require('@date-fns/upgrade/v2');
...
var formatDate = function formatDate(date, dateFormat) {
  return date ? format(startOfDay(date), v2.convertTokens(dateFormat)) : undefined;
};
...
var parseOnBlur = function parseOnBlur(typedValue, formatString) {
  return dateFns.parse(typedValue, parseFormatString(formatString), new Date());
};
var parseRangeOnBlur = function parseRangeOnBlur(typedValue, formatString) {
  ...
  return rangeValues.map(function (value) {
    return dateFns.parse(value, parsedFormatString, new Date());
  }).sort(function (a, b) {
    return a > b ? 1 : -1;
  });
};
...
var CustomInput = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
  ...
  return React__default.createElement(semanticUiReact.Form.Field, {
    ...
    htmlFor: rest.id
  }, label), React__default.createElement(semanticUiReact.Input, Object.assign({
